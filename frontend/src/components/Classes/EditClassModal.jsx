// frontend/src/components/Classes/EditClassModal.jsx
...
const EditClassModal = ({ isOpen, klass, onSubmit, onClose, error, setError }) => {
  ...
  useEffect(() => {
    if (!isOpen || !klass) return;
    setForm({
      name: klass.name || '',
      level: klass.level || '',
      termFee: klass.termFee != null ? String(klass.termFee) : '',
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Edit Class</h2>
          <button
            onClick={onClose}
