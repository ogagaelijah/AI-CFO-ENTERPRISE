// frontend/src/components/Purchases/EditPurchaseModal.jsx
import { useState, useEffect } from 'react';
import { X } from 'lucide-react';

const EditPurchaseModal = ({ isOpen, purchase, onSubmit, onClose, error, setError }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white dark:bg-slate-800 rounded-xl shadow-xl max-w-md w-full">
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-slate-700 sticky top-0 bg-white dark:bg-slate-800 z-10">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Edit Purchase</h2>
          <button
            onClick={onClose}
