...
const SummaryCards = ({ summary }) => {
  const cards = [
    { key: 'total_entries', label: 'Total Entries', icon: TrendingDown, value: summary?.total_entries || 0 },
    { key: 'total_amount', label: 'Total Expenses', icon: DollarSign, value: `₦${(summary?.total_amount || 0).toLocaleString()}`, textColor: 'text-red-600 dark:text-red-400' },
